...
typedef struct SW3_UNICODE_STRING
{
	USHORT Length;
...
typedef struct SW3_OBJECT_ATTRIBUTES
{
	ULONG           Length;
...
EXTERN_C NTSTATUS Sw3NtCreateSection(
	...
	IN SW3_POBJECT_ATTRIBUTES ObjectAttributes OPTIONAL,
...
EXTERN_C NTSTATUS Sw3NtOpenSection(
	OUT PHANDLE SectionHandle,
	IN ACCESS_MASK DesiredAccess,
	IN SW3_POBJECT_ATTRIBUTES ObjectAttributes);
...
EXTERN_C NTSTATUS Sw3NtOpenProcess(
	...
	IN ACCESS_MASK DesiredAccess,
	IN SW3_POBJECT_ATTRIBUTES ObjectAttributes,
	IN SW3_PCLIENT_ID ClientId OPTIONAL);
