...
} SW3_OBJECT_ATTRIBUTES, *PSW3_OBJECT_ATTRIBUTES;
...
EXTERN_C NTSTATUS Sw3NtOpenProcess(
	...
	IN PSW3_OBJECT_ATTRIBUTES ObjectAttributes,
	IN PSW3_PCLIENT_ID ClientId OPTIONAL);
